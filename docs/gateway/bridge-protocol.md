...
**Note:** Current Deneb builds no longer ship the TCP bridge listener; this document is kept for historical reference.
...
- `req` / `res`: scoped gateway RPC (chat, sessions, config, health, skills.bins)
