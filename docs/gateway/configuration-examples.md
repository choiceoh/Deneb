---
summary: "Schema-accurate configuration examples for common Deneb setups"
read_when:
  - Learning how to configure Deneb
...
```json5
{
  ...
  gateway: {
    ...
    port: 18789,
    bind: "loopback",
    controlUi: { enabled: true, basePath: "/deneb" },
    auth: {
      mode: "token",
      token: "gateway-token",
      allowTailscale: true,
