---
summary: "First-run setup flow for Deneb (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Deneb">
...
<Step title="CLI">
  ...
  The app can install the global `deneb` CLI via npm/pnpm so terminal
