---
summary: "Overview of Deneb onboarding options and flows"
read_when:
...
Deneb supports multiple onboarding paths depending on where the Gateway runs
...
Use the Deneb app when you want a fully guided setup on macOS. Docs:
