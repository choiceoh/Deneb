...
It is modeled after Claude Code's `/btw` behavior, but adapted to Deneb's
...
If the main run is currently active, Deneb snapshots the current message
...
On channels like Telegram, WhatsApp, and Telegram, BTW is delivered as a
