...
Set plugin-wide defaults in `~/.deneb/deneb.json`:
...
- Artifacts are stored under the temp subfolder: `$TMPDIR/deneb-diffs`.
...
1. `browser.executablePath` in Deneb config.
2. Environment variables:
   - `DENEB_BROWSER_EXECUTABLE_PATH`
