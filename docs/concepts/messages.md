...
This page ties together how Deneb handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Deneb keeps a
...
Deneb separates the **prompt body** from the **command body**:
...
default) and per-channel overrides like `channels.telegram.historyLimit` or
...
Deneb can expose or hide model reasoning:
