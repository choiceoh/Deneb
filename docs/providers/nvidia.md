---
summary: "Use NVIDIA's OpenAI-compatible API in Deneb"
read_when:
  - You want to use NVIDIA models in Deneb
...
deneb onboard --auth-choice skip
deneb models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
