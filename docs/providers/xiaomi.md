---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Deneb"
read_when:
  - You want Xiaomi MiMo models in Deneb
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Deneb uses
...
```bash
deneb onboard --auth-choice xiaomi-api-key
# or non-interactive
deneb onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
