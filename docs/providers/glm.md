---
summary: "GLM model family overview + how to use it in Deneb"
read_when:
  - You want GLM models in Deneb
...
GLM is a **model family** (not a company) available through the Z.AI platform. In Deneb, GLM
