---
summary: "Use Qianfan's unified API to access many models in Deneb"
read_when:
...
3. Deneb installed on your system
...
4. Copy the API key for use with Deneb

## CLI setup

```bash
deneb onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Deneb Configuration](/gateway/configuration)
