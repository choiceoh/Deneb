...
You can point Deneb at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Deneb
...
- [Anthropic provider](/providers/anthropic) - Native Deneb integration with Claude setup-token or API keys
