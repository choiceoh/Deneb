---
title: "Kilo Gateway"
summary: "Use Kilo Gateway's unified API to access many models in Deneb"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Deneb
---
...
```bash
deneb onboard --kilocode-api-key <key>
```
...
Deneb dynamically discovers available models from the Kilo Gateway at startup. Use
