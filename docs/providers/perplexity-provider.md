...
**tool** (how the agent uses it), see [Perplexity tool](/tools/perplexity).
</Note>
...
```bash
deneb config set tools.web.search.perplexity.apiKey "pplx-xxxxxxxxxxxx"
```
