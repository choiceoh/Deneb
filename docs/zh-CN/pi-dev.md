...
本指南总结了在 Deneb 中开发 Pi 集成的合理工作流程。
...
状态存储在 Deneb 状态目录下。默认为 `~/.deneb`。如果设置了 `DENEB_STATE_DIR`，则使用该目录。
...
- https://docs.deneb.ai/testing
- https://docs.deneb.ai/start/getting-started
