---
read_when:
  - 你想在 Deneb 中使用 Xiaomi MiMo 模型
  - 你需要设置 `XIAOMI_API_KEY`
summary: 在 Deneb 中使用 Xiaomi MiMo（`mimo-v2-flash`）
title: Xiaomi MiMo
x-i18n:
...
[Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys) 中创建你的 API key。Deneb 使用
