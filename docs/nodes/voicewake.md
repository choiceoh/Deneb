...
Deneb treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.deneb/settings/voicewake.json`

Shape:

```json
{ "triggers": ["deneb", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
