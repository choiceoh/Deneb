...
| Symptom                         | Fastest check                       | Fix                                                       |
| ------------------------------- | ----------------------------------- | --------------------------------------------------------- |
| Bot online but no guild replies | `deneb channels status --probe`  | Allow guild/channel and verify message content intent.    |
...
| Symptom                                | Fastest check                             | Fix                                               |
| -------------------------------------- | ----------------------------------------- | ------------------------------------------------- |
| Socket mode connected but no responses | `deneb channels status --probe`        | Verify app token + bot token and required scopes. |
...
| Symptom                         | Fastest check                              | Fix                                                      |
| ------------------------------- | ------------------------------------------ | -------------------------------------------------------- |
| Daemon reachable but bot silent | `deneb channels status --probe`         | Verify `signal-cli` daemon URL/account and receive mode. |
...
| Symptom                             | Fastest check                                | Fix                                             |
| ----------------------------------- | -------------------------------------------- | ----------------------------------------------- |
| Logged in but ignores room messages | `deneb channels status --probe`           | Check `groupPolicy` and room allowlist.         |
