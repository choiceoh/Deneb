...
read_when:
  ...
  - Reviewing Deneb security posture
title: "Pairing"
---

# Pairing

“Pairing” is Deneb’s explicit **owner approval** step.
...
Stored under `~/.deneb/credentials/`:
...
3. On your phone, open the Deneb iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `deneb nodes pending/approve`) is a
