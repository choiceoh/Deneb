...
- Install via CLI: `deneb plugins install @deneb/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `deneb plugins install ./extensions/zalo`
   - From npm (if published): `deneb plugins install @deneb/zalo`
...
This page reflects current Deneb behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `deneb pairing list zalo`
  - `deneb pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Deneb.
...
- Example: `deneb message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `deneb channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `deneb logs --follow`
