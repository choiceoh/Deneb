---
summary: "Deneb is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Deneb to newcomers
title: "Deneb"
---
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Deneb and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `deneb onboard` and pairing flows.
  </Card>
