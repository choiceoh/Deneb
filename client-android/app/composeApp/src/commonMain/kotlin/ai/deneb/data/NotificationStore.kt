...
/**
 * Persistence for notifications captured by [ai.deneb.notifications.DenebNotificationListenerService].
 *
 * Two collections:
 ...
 * - **Store** — broader rolling history backing [ai.deneb.notifications.NotificationReader],
