package ai.deneb.network.dtos.openaicompatible
...
data class OpenAICompatibleChatRequestDto(
    ...
    // for interactive UI mode, where the whole screen must arrive as one un-truncated deneb-ui
    ...
    // set to "low" in interactive UI mode so thinking doesn't eat the deneb-ui JSON budget.
