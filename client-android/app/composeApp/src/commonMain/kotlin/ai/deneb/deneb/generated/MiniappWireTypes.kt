...
data class EngineDay(
    ...
    val cachePromptTokens: Long = 0L,
    val promptCacheMeasured: Boolean = false,
    val prefixRequestHitRatio: Double = 0.0,
    val prefixLookupRequests: Long = 0L,
    val prefixHitRequests: Long = 0L,
