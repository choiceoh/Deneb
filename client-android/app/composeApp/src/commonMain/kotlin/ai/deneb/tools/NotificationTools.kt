...
import deneb.composeapp.generated.resources.tool_check_notifications_description
import deneb.composeapp.generated.resources.tool_check_notifications_name
import deneb.composeapp.generated.resources.tool_read_notification_description
import deneb.composeapp.generated.resources.tool_read_notification_name
import deneb.composeapp.generated.resources.tool_search_notifications_description
import deneb.composeapp.generated.resources.tool_search_notifications_name
    ...
    fun checkNotificationsTool(store: NotificationStore, reader: NotificationReader) = object : Tool {
        ...
        override suspend fun execute(args: Map<String, Any>): Any {
            ...
            if (!reader.hasAccess()) {
                return mapOf(
                    "success" to false,
                    "error" to "Notification access not granted. Ask the user to enable Deneb under " +
