...
actual class LocationPermissionController actual constructor() {
    ...
    actual fun hasPermission(): Boolean = ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED ||
...
@Composable
actual fun SetupLocationPermissionHandler(controller: LocationPermissionController) {
