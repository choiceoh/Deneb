...
// Full national digits — must mirror gateway-go contacts.normalizePhone, NOT a
// trailing-8 suffix. The old takeLast(8) key made 010-1234-5678 and 02-1234-5678
// collide, so apply could link unrelated people the dedup pass kept separate.
