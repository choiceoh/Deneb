...
import ai.deneb.data.HeartbeatConfig
...
import ai.deneb.data.ServiceInstance
import ai.deneb.data.SmsDraft
import ai.deneb.data.SmsSyncState
import ai.deneb.data.SystemPromptVariant
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(question: String?, files: List<PlatformFile>, uiSubmission: ai.deneb.data.UiSubmission?) {
    ...
    override fun getNotificationSyncState(): ai.deneb.data.NotificationSyncState = ai.deneb.data.NotificationSyncState()
