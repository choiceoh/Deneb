...
// project.sites — every active project carrying a 현장, for the 현장 지도.
// Spans several 시도 with mixed due dates so the map's urgency colors and the
// 미배치 tray are visible in mock-mode screenshots.
export const projectSites: ProjectSiteRow[] = [
  {
    project: "군산 수산리 태양광",
    client: "금호타이어",
    sites: ["전북 군산시 옥구읍 수산리"],
    due: "2026-07-18",
    path: "projects/gunsan",
  },
  {
    project: "화성 향남 태양광",
    client: "한화솔루션",
  ...
  },
  {
    ...
    sites: ["충남 당진시 석문면"],
    due: "2026-07-13",
    path: "projects/dangjin",
  },
  { project: "태백 황지 풍력", client: "강원풍력", sites: ["강원 태백시 황지동"], path: "projects/taebaek" },
  {
    project: "청주 서원 태양광",
    client: "충북에너지",
    sites: ["충북 청주시 서원구"],
    due: "2026-08-15",
    path: "projects/cheongju",
  },
  {
    project: "인천 미추홀 루프탑",
    client: "인천도시공사",
  ...
  { project: "새만금 3구역", client: "농어촌공사", sites: ["황해도 어딘가면"], path: "projects/saemangeum" },
];
