...
- Keep product names in English: Deneb, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Deneb Gateway, use “Gateway 网关”.
