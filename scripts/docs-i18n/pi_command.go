...
const (
	envDocsPiExecutable     = "DENEB_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "DENEB_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "DENEB_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "deneb", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
