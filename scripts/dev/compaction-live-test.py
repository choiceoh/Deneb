...
Requirements:
  - Dev gateway running (scripts/live-test.sh restart)
  - Test data generated (scripts/compaction-gen-testdata.py)
  - pip install websockets

Usage:
  python3 scripts/compaction-live-test.py [PORT]
  # Default port: 18791
...
async def main():
    ...
    for i in range(1, 6):
        ...
        if not os.path.exists(path):
            ...
            print(f"Run: python3 scripts/compaction-gen-testdata.py")
            sys.exit(1)
