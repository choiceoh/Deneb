...
"""
    ...
    def test_when_python_centralized_import_maps_risk_to_production_package(self) -> None:
        source = """\
import subprocess
...
"""
    ...
    def test_when_kotlin_import_requires_a_per_case_production_call(self) -> None:
        source = """\
...
"""
    ...
    def test_when_kotlin_extension_function_is_a_discoverable_subject(self) -> None:
        source = """\
...
"""
    ...
    def test_when_generated_suite_contributes_one_effective_shape_only(self) -> None:
        source = """\
...
"""
    ...
    def test_when_cloned_asserted_shapes_do_not_manufacture_confidence(self) -> None:
        with _GitFixture() as fixture:
    ...
    def test_when_lexical_noise_cannot_launder_oracle_or_risk_evidence(self) -> None:
        go_source = """\
package widget
...
"""
    ...
    def test_when_comment_padding_changes_only_unscored_size_diagnostic(self) -> None:
...
"""
    ...
    def test_when_trivial_source_cannot_dilute_hotspots_and_receiver_ids_are_unique(self) -> None:
...
"""
    ...
    def test_when_fake_do_not_edit_header_is_not_a_generated_test_exemption(self) -> None:
        fake = (
    ...
    def test_when_untracked_scratch_files_do_not_change_inventory_or_scores(self) -> None:
        with _GitFixture() as fixture:
            fixture.write("gateway-go/go.mod", "module example.invalid/fixture\n")
            fixture.write("gateway-go/internal/widget/widget.go", self._SOURCE)
            fixture.write("gateway-go/internal/widget/widget_test.go", self._BASE_TEST)
    ...
    def test_when_merge_head_history_includes_pr_diff_like_a_squash_commit(self) -> None:
        with _GitFixture() as fixture:
            fixture.write(
    ...
    def test_when_high_complexity_and_runtime_risk_score_below_simple_code(self) -> None:
        simple = """\
package worker
