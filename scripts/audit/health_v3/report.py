"""Human/markdown rendering for Health Bench 3.0."""

from __future__ import annotations

from .model import Report, RUBRIC_VERSION


def render_human(report: Report, *, top: int = 5) -> str:
    lines = [
        f"Health Bench 3.0  overall = {report.overall:.1f}/100  "
...
def render_markdown(report: Report, *, top: int = 5) -> str:
    lines = [
        f"# Health Bench 3.0 — {report.overall:.1f}/100",
        "",
