import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "deneb/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "deneb/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "deneb/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/deneb"),
    },
    modelAuth: {
