...
mod tests {
    ...
    #[test]
    fn test_ffi_error_code_proto_consistency() {
        // Verify FFI_ERR_* constants match negated FfiErrorCode proto values.
        assert_eq!(
            FFI_ERR_NULL_POINTER,
            -(gen::gateway::FfiErrorCode::NullPointer as i32),
            "FFI_ERR_NULL_POINTER must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_INVALID_UTF8,
            -(gen::gateway::FfiErrorCode::InvalidUtf8 as i32),
            "FFI_ERR_INVALID_UTF8 must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_OUTPUT_TOO_SMALL,
            -(gen::gateway::FfiErrorCode::OutputTooSmall as i32),
            "FFI_ERR_OUTPUT_TOO_SMALL must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_INPUT_TOO_LARGE,
            -(gen::gateway::FfiErrorCode::InputTooLarge as i32),
            "FFI_ERR_INPUT_TOO_LARGE must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_JSON_ERROR,
            -(gen::gateway::FfiErrorCode::JsonError as i32),
            "FFI_ERR_JSON_ERROR must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_OVERFLOW,
            -(gen::gateway::FfiErrorCode::Overflow as i32),
            "FFI_ERR_OVERFLOW must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_VALIDATION,
            -(gen::gateway::FfiErrorCode::Validation as i32),
            "FFI_ERR_VALIDATION must be negated proto value"
        );
        assert_eq!(
            FFI_ERR_RUST_PANIC,
            -(gen::gateway::FfiErrorCode::RustPanic as i32),
            "FFI_ERR_RUST_PANIC must be negated proto value"
        );
    }
}
