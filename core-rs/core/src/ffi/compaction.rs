//! Compaction evaluation and sweep state machine FFI exports.
...
pub unsafe extern "C" fn deneb_compaction_evaluate(
    ...
    ffi_catch(FFI_ERR_PANIC, move || {
        ...
        ffi_write_json(&decision, out_slice)
    })
}
