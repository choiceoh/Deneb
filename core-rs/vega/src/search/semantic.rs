...
//!
//! Provides vector-based search using pre-computed embeddings from the
//! Gemini Embedding API (passed from Go). SIMD-accelerated cosine similarity
//! and rayon parallelism for high throughput on DGX Spark.
