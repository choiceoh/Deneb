...
pub use resolve::{
    ...
    get_subagent_depth,
    has_configured_model_fallbacks,
    is_acp_session_key,
    ...
    resolve_agent_effective_model_primary,
    resolve_agent_explicit_model_primary,
    ...
    resolve_effective_model_fallbacks,
    resolve_fallback_agent_id,
    resolve_run_model_fallbacks_override,
    ...
    // Types
    AgentEntry,
    BuildAgentPeerSessionKeyParams,
