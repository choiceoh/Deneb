...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.deneb.gateway\n";
    const listed = isLaunchAgentListed({
      env: { HOME: "/Users/test", DENEB_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.deneb.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when DENEB_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.deneb.gateway.plist",
    },
    {
      name: "uses profile-specific label when DENEB_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", DENEB_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.deneb.jbphoenix.plist",
    },
    {
      name: "prefers DENEB_LAUNCHD_LABEL over DENEB_PROFILE",
      env: {
        HOME: "/Users/test",
        DENEB_PROFILE: "jbphoenix",
        DENEB_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from DENEB_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        DENEB_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty DENEB_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        DENEB_PROFILE: "myprofile",
        DENEB_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.deneb.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
