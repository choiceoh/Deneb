...
describe("resolveGatewayProgramArguments", () => {
  it("uses realpath-resolved dist entry when running via npx shim", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/deneb");
    const entryPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/deneb/dist/entry.js");
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/deneb is a symlink
    // to .pnpm/deneb@X.Y.Z/node_modules/deneb
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/deneb/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/deneb@2026.1.21-2/node_modules/deneb/dist/entry.js",
    );
  ...
  it("falls back to node_modules package dist when .bin path is not resolved", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/deneb");
    const indexPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/deneb/dist/index.js");
    process.argv = ["node", argv1];
