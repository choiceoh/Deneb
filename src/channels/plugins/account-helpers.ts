...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: DenebConfig): string | undefined {
  ...
  function listAccountIds(cfg: DenebConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: DenebConfig): string {
