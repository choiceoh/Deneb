...
export function listChannelMessageActions(cfg: DenebConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: DenebConfig): ChannelMessageCapability[] {
