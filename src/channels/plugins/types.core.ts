...
export type ChannelAgentToolFactory = (params: { cfg?: DenebConfig }) => ChannelAgentTool[];
...
export type ChannelMessagingAdapter = {
  ...
  enableInteractiveReplies?: (params: { cfg: DenebConfig; accountId?: string | null }) => boolean;
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: DenebConfig; accountId?: string | null }) => string[];
};
