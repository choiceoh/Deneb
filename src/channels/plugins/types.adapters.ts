...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: DenebConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: DenebConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: DenebConfig) => string;
  setAccountEnabled?: (params: {
    cfg: DenebConfig;
    accountId: string;
    enabled: boolean;
  }) => DenebConfig;
  deleteAccount?: (params: { cfg: DenebConfig; accountId: string }) => DenebConfig;
  isEnabled?: (account: ResolvedAccount, cfg: DenebConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: DenebConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: DenebConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: DenebConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: DenebConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.deneb.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: DenebConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: DenebConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: DenebConfig; accountId?: string | null }) =>
    | {
