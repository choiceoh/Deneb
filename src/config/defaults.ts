...
import { normalizeProviderId, parseModelRef } from "../agents/models/model-selection.js";
...
function resolveAnthropicDefaultAuthMode(cfg: DenebConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: DenebConfig): DenebConfig {
...
export function applyTalkApiKey(config: DenebConfig): DenebConfig {
...
export function applyTalkConfigNormalization(config: DenebConfig): DenebConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: DenebConfig): DenebConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: DenebConfig): DenebConfig {
...
export function applyLoggingDefaults(cfg: DenebConfig): DenebConfig {
...
export function applyContextPruningDefaults(cfg: DenebConfig): DenebConfig {
