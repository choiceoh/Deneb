...
export function listBindings(cfg: DenebConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: DenebConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: DenebConfig) {
