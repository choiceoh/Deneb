...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: DenebConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__denebMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__denebMcporterColdStartWarned;
  });
