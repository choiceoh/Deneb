...
function resolveAvatarSource(cfg: DenebConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: DenebConfig, agentId: string): AgentAvatarResolution {
