...
const CLEANUP_STATE_KEY = Symbol.for("deneb.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("deneb.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("deneb.sessionWriteLockWatchdogState");
