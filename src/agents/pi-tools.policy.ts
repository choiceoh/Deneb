...
export function resolveSubagentToolPolicy(cfg?: DenebConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: DenebConfig["tools"]): string[] | undefined {
