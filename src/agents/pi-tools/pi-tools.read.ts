...
function resolveAdaptiveReadMaxBytes(options?: DenebReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createDenebReadTool(base, {
...
export function createDenebReadTool(
  base: AnyAgentTool,
  options?: DenebReadToolOptions,
): AnyAgentTool {
