import type { DenebConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: DenebConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: DenebConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[deneb]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: DenebConfig, channel: string): Record<string, unknown> | undefined {
