...
function resolveWatchPaths(workspaceDir: string, config?: DenebConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: DenebConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: DenebConfig }) {
