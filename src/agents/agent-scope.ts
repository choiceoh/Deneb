...
type AgentEntry = NonNullable<NonNullable<DenebConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: DenebConfig): AgentEntry[] {
...
export function listAgentIds(cfg: DenebConfig): string[] {
...
export function resolveDefaultAgentId(cfg: DenebConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: DenebConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentSkillsFilter(cfg: DenebConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: DenebConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: DenebConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentIdsByWorkspacePath(cfg: DenebConfig, workspacePath: string): string[] {
