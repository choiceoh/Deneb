...
type ExecHost = "gateway" | "sandbox" | "node";
function minSecurity(a: string, b: string): string {
  return a === "full" || b === "full" ? "full" : a;
}
function maxAsk(a: string, b: string): string {
  return a === "always" || b === "always" ? "always" : a;
}
