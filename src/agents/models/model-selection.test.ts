...
function resolveAnthropicOpusThinking(cfg: DenebConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<DenebConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<DenebConfig>) {
