...
import { wrapStreamFnRepairMalformedToolCallArguments } from "./stream-tool-call-repair.js";
import { wrapStreamFnTrimToolCallNames } from "./stream-tool-call-sanitize.js";
import { decodeHtmlEntitiesInObject } from "./stream-xai-decode.js";
  ...
  it("includes resolved auth profile fields for context-engine afterTurn compaction", () => {
    const legacy = buildAfterTurnRuntimeContext({
      attempt: {
        ...
        agentAccountId: "acct-1",
        authProfileId: "openai:p1",
        config: { plugins: { slots: { contextEngine: "aurora" } } } as DenebConfig,
        skillsSnapshot: undefined,
        senderIsOwner: true,
        provider: "openai-codex",
        modelId: "gpt-5.3-codex",
