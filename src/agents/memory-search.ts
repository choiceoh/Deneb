...
import type { DenebConfig, MemorySearchConfig } from "../config/config.js";
...
const DEFAULT_CHUNK_TOKENS = 500; // Slightly larger chunks (up from 400)
const DEFAULT_CHUNK_OVERLAP = 100; // Proportional overlap (up from 80)
const DEFAULT_WATCH_DEBOUNCE_MS = 800; // Snappier watch (down from 1500)
const DEFAULT_SESSION_DELTA_BYTES = 100_000;
const DEFAULT_SESSION_DELTA_MESSAGES = 50;
const DEFAULT_MAX_RESULTS = 8; // Slightly more (up from 6)
