...
export const A2UI_PATH = "/__deneb__/a2ui";

export const CANVAS_HOST_PATH = "/__deneb__/canvas";

export const CANVAS_WS_PATH = "/__deneb__/ws";
...
(() => {
  ...
  globalThis.Deneb = globalThis.Deneb ?? {};
  globalThis.Deneb.postMessage = postToNode;
  globalThis.Deneb.sendUserAction = sendUserAction;
  globalThis.denebPostMessage = postToNode;
  globalThis.denebSendUserAction = sendUserAction;
