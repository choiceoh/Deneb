...
export function collectConfiguredModelPricingRefs(config: DenebConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: DenebConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
