...
describe("gateway auth", () => {
  ...
  it("resolves token/password from DENEB gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          DENEB_GATEWAY_TOKEN: "env-token",
          DENEB_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides DENEB_GATEWAY_PASSWORD", () => {
