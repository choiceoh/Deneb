...
export function hasAmbiguousGatewayAuthModeConfig(cfg: DenebConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: DenebConfig): void {
