...
export function applyProviderDefaultModel(cfg: DenebConfig, modelRef: string): DenebConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: DenebConfig; modelId: string; modelRef: string; profileId: string } {
