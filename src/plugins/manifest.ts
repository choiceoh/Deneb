...
export const PLUGIN_MANIFEST_FILENAME = "deneb.plugin.json";
...
// package.json "deneb" metadata (used for setup/catalog)
...
export type DenebPackageStartup = {
  /**
...
export type DenebPackageManifest = {
  extensions?: string[];
  setupEntry?: string;
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
  startup?: DenebPackageStartup;
};
...
): DenebPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
