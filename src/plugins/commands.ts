...
type RegisteredPluginCommand = DenebPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
function listPluginInvocationKeys(command: DenebPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: DenebPluginCommandDefinition): string[] {
