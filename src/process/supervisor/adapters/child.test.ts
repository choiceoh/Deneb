...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.DENEB_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.DENEB_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.DENEB_SERVICE_MARKER = originalServiceMarker;
    }
  });
