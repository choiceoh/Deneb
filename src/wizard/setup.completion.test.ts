...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("deneb");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "deneb");
