...
export function listAuthProfileStorePaths(config: DenebConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: DenebConfig, stateDir: string): string[] {
