...
function resolveResolutionLimits(config: DenebConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: DenebConfig): SecretProviderConfig {
