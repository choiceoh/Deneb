...
export function isAcpEnabledByPolicy(cfg: DenebConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: DenebConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: DenebConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: DenebConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: DenebConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: DenebConfig, agentId: string): boolean {
