...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: DenebConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: DenebConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: DenebConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: DenebConfig }): Promise<void> {
