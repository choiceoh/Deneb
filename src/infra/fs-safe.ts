...
export async function openVerifiedLocalFile(
  ...
  // results that get sent to messaging channels). See deneb/deneb#31186.
  try {
...
// Re-export write operations from fs-safe-write.ts for backward compatibility.
export {
