...
function isFeishuDocToolEnabled(cfg: DenebConfig): boolean {
...
function collectLoggingFindings(cfg: DenebConfig): SecurityAuditFinding[] {
...
function collectElevatedFindings(cfg: DenebConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
function collectExecRuntimeFindings(cfg: DenebConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
