/**
 * Gateway-config security audit findings.
 *
 * Covers bind/auth mode, trusted-proxy setup, Control UI origin policy,
 * mDNS exposure, Tailscale mode, and tool-invoke HTTP re-enables.
 */
import { isIP } from "node:net";
import type { DenebConfig } from "../config/config.js";
import { hasConfiguredSecretInput } from "../config/types.secrets.js";
import { resolveGatewayAuth } from "../gateway/auth/auth.js";
import { hasNonEmptyString, isFeishuDocToolEnabled } from "./audit.helpers.js";
...
export function isStrictLoopbackTrustedProxyEntry(entry: string): boolean {
