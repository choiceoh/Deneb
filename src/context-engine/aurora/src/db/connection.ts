...
export function getAuroraConnection(dbPath: string): DatabaseSync {
 ...
 */
export function closeAuroraConnection(dbPath: string): void {
...
/**
 * Force-close ALL open Aurora connections. Only for process shutdown / cleanup.
 */
export function closeAllAuroraConnections(): void {
