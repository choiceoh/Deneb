...
const AuroraGrepSchema = Type.Object({
  pattern: Type.String({
    description:
...
export function createAuroraGrepTool(input: {
  ...
  return {
    ...
    description:
      ...
      "Searches across messages and/or summaries stored by Aurora. " +
      ...
      "for follow-up with aurora_expand or aurora_describe.",
    parameters: AuroraGrepSchema,
    async execute(_toolCallId, params) {
      ...
      const lines: string[] = [];
      lines.push("## Aurora Grep Results");
