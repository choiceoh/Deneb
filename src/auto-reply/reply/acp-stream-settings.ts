...
function resolveAcpStreamCoalesceIdleMs(cfg: DenebConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: DenebConfig): number {
...
export function resolveAcpProjectionSettings(cfg: DenebConfig): AcpProjectionSettings {
