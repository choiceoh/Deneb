  ...
  const cases: Array<{ name: string; ctx: MsgContext }> = [
    ...
    },
    {
      ...
      ctx: {
        ...
        Surface: "mattermost",
        ChatType: "channel",
        From: "mattermost:channel:19:abc@thread.tacv2",
        To: "mattermost:channel:19:abc@thread.tacv2",
        Body: "[Teams] hi",
        RawBody: "hi",
        CommandBody: "hi",
