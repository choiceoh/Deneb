...
export function isCommandEnabled(cfg: DenebConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: DenebConfig): {
  provider: string;
  model: string;
} {
  const resolved = resolveConfiguredModelRef({
    cfg: cfg ?? ({} as DenebConfig),
...
export function maybeResolveTextAlias(raw: string, cfg?: DenebConfig) {
