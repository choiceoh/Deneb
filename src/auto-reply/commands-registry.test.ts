...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@deneb", { botUsername: "deneb" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@deneb args", {
        botUsername: "deneb",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "deneb" })).toBe("/help@otherbot");
  });
