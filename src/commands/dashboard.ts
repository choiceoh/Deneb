...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set DENEB_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `deneb dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Deneb.");
  } else if (hint) {
    runtime.log(hint);
  }
}
