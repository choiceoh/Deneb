...
import { readGatewayPasswordEnv, readGatewayTokenEnv } from "../../gateway/auth/credentials.js";
...
export function resolveTargets(cfg: DenebConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
export function buildNetworkHints(cfg: DenebConfig) {
