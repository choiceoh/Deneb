...
function resolveDefaultAccountId(cfg: DenebConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: DenebConfig): boolean {
...
export function summarizeBindings(cfg: DenebConfig, bindings: AgentBinding[]): string[] {
