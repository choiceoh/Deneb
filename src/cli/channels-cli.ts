    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["deneb channels list", "List configured channels and auth profiles."],
          ["deneb channels status --probe", "Run channel status checks and probes."],
          [
            "deneb channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["deneb channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.deneb.ai/cli/channels",
        )}\n`,
    );
