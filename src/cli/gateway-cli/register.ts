      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["deneb gateway run", "Run the gateway in the foreground."],
            ["deneb gateway status", "Show service status and probe reachability."],
            ["deneb gateway discover", "Find local and wide-area gateway beacons."],
            ["deneb gateway call health", "Call a gateway RPC method directly."],
