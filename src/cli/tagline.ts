const DEFAULT_TAGLINE = "All your chats, one Deneb.";
...
const TAGLINES: string[] = [
  ...
  "Good to the last token — like fresh butter on warm starlight.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The star that actually answers. ⭐ ⭐",
  ...
  "Built for humans, powered by stars. ⭐",
  ...
  "You had me at 'deneb gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.DENEB_TAGLINE_INDEX;
