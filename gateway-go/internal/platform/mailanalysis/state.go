// Package mailanalysis implements the mail analysis pipeline (stage-1 context
// extraction → stage-2 synthesis → local extractors) shared by every mail
// intake — the LMTP push server, kakao/IMAP IDLE single-shot triggers, and the
// optional legacy Gmail poller (Service) this package started as.
