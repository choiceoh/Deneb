...
// Handle captures one structured log record.
...
// WithAttrs returns a capture handler carrying the supplied attributes.
...
// WithGroup returns a capture handler scoped to the supplied group.
