...
func (s *Handler) FilesDownload(w http.ResponseWriter, r *http.Request) {
...
func (s *Handler) authorizeFileDownload(w http.ResponseWriter, r *http.Request, virt string) bool {
	q := r.URL.Query()
