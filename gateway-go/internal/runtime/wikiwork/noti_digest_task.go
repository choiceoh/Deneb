...
3. 반영 방법 (기존 규약 그대로):
   - 프로젝트 관련 사실 → 해당 프로젝트 로그.md에 '## [YYYY-MM-DD] <op> | <주제>' 섹션 append (op: 결재/이슈/일정 등). wiki(action=read)로 어느 프로젝트인지 확인 후 쓰세요 — 불확실하면 쓰지 않습니다
...
4. 출처 표기: 각 반영 항목에 근거를 짧게 병기하세요 (예: "카카오톡 <방이름> 알림, MM-DD").
5. 남길 것이 하나도 없으면 아무것도 쓰지 말고 조용히 종료하세요 — 억지 기록 금지.
