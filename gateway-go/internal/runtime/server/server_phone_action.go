...
// misleadingly). Best-effort otherwise — the SSE hub drops frames for an
// asleep consumer (Doze); a phone action that must survive a closed app is out
// of P1 scope (FCM-data follow-up).
