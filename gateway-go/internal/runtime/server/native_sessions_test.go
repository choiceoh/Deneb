...
func TestRestorableTranscriptSession(t *testing.T) {
	cases := []struct {
		...
		{"chat:9705506a-5735-411e-a53a-b7ad5a0a7140", true},        // legacy 챗봇 conversation (chat:<uuid>)
		{"chat:main", true},                    // legacy 챗봇 home-style key
		{"chat:main:e2e-title-fresh-01", true}, // legacy 챗봇 sub-conversation
