...
// Lightweight-LLM card titler for proactive work-feed cards.
//
...
// Best-effort: any failure returns "" and proactive_relay falls back to the
// deterministic extractCardTitle heuristic.
...
// cardTitle returns a lightweight-model-generated card title for a proactive body,
// or "" on any failure (so the heuristic fallback applies). It is wired as
