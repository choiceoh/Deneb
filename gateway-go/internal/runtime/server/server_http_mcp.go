...
func (s *Server) handleMCPToolCall(w http.ResponseWriter, r *http.Request, identity *clientauth.Identity, msg mcpMessage) {
	var p struct {
...
// gateway speaks it, else answers with the newest supported revision.
...
func (s *Server) writeMCPFrame(w http.ResponseWriter, frame map[string]any) {
