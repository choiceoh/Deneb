...
func newCalendarSignalCollector(resolve func() (runtimemeeting.CalendarClient, error)) func(ctx context.Context) autonomous.SignalInputs {
	if resolve == nil {
		return nil
	}
...
func CalendarSignalCollector(resolve func() (runtimemeeting.CalendarClient, error)) func(context.Context) autonomous.SignalInputs {
	return newCalendarSignalCollector(resolve)
}
