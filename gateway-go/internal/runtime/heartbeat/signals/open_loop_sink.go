...
func TodoDeadlineCollector() func(context.Context) autonomous.SignalInputs {
	return newTodoDeadlineCollector()
}
...
func CombineCollectors(collectors ...func(context.Context) autonomous.SignalInputs) func(context.Context) autonomous.SignalInputs {
	return combineSignalCollectors(collectors...)
}
