...
func TestPublisherEmitsEnrichedSessionMessageToScopedRecipients(t *testing.T) {
	...
	seq := 7
	pub.PublishSessionMessage(TranscriptUpdate{SessionKey: "session-1", MessageID: "message-1", MessageSeq: &seq, Message: mustPayload(t, map[string]any{"role": "assistant"})})
