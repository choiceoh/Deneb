...
//
// AnalysisStore lives here (rather than in the parent handlermail
// package) because both this package's list/get rows and the sibling
// analyzebind package's analyze/ask handlers read and write it; the
// parent re-exports it via a type alias for server call sites.
package gmailops
...
// AnalysisRecord is the on-disk shape of one cached analysis. Exported so
// the sibling analyzebind package can read/write records directly.
