...
func todoList(deps TodoDeps) rpcutil.HandlerFunc {
	...
	return minibind.BindOptional[

	// Params are optional — an empty body lists everything.
	params](func(ctx context.Context, req *protocol.RequestFrame, p params) *protocol.ResponseFrame {
...
func todoCreate(deps TodoDeps) rpcutil.HandlerFunc {
	return minibind.Bind[todoInput](func(ctx context.Context, req *protocol.RequestFrame, p todoInput) *protocol.ResponseFrame {
