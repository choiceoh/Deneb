...
func TestExecute_ReturnsDoneWithOutputForSimpleCommand(t *testing.T) {
	m := newTestManager(t)
...
func TestExecute_PreventsStdoutLossUnderDrainRace(t *testing.T) {
	m := newTestManager(t)
	for i := range 200 {
		result := m.Execute(context.Background(), ExecRequest{
...
func TestExecute_FailsForNonExistentCommand(t *testing.T) {
	m := newTestManager(t)
...
func TestExecute_ApprovalDeniedReturnsDeniedStatus(t *testing.T) {
	m := newTestManager(t)
...
func TestExecute_ApprovalGrantedAllowsExecution(t *testing.T) {
	m := newTestManager(t)
...
func TestExecute_WithoutApproverIsDenied(t *testing.T) {
	m := newTestManager(t)
...
func TestGetAndList_ReturnTrackedProcesses(t *testing.T) {
	m := newTestManager(t)
...
func TestKill_ReturnsErrorForUnknownProcess(t *testing.T) {
	m := newTestManager(t)
...
func TestPrune_EvictsExpiredProcess(t *testing.T) {
	m := newTestManager(t)
...
func TestExecute_CreatesAutoGeneratedID(t *testing.T) {
	m := newTestManager(t)
...
func TestExecuteBackground_StartsAndCompletesProcess(t *testing.T) {
	m := newTestManager(t)
...
func TestParallelDrain_HandlesLargeConcurrentOutput(t *testing.T) {
...
func TestEnvCache_ReloadsAfterInvalidate(t *testing.T) {
	m := newTestManager(t)
