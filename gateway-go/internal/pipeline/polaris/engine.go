...
type Engine struct {
	...
	anchorKeywords []string // wiki Tier1 page titles/IDs to preserve through summarization
}
...
// SetAnchorKeywords sets wiki Tier1 page titles/IDs whose related facts MUST
// be preserved through summarization. Safe to call concurrently — the keyword
// list is snapshotted into the per-call compaction config.
