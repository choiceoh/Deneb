...
func TestToolMarketReturnsFreshQuotes(t *testing.T) {
	...
	fetch := func(context.Context) ([]tooldeps.MarketQuote, int64, bool, error) {
		return []tooldeps.MarketQuote{
...
func TestToolMarket_StaleAndError(t *testing.T) {
	stale := func(context.Context) ([]tooldeps.MarketQuote, int64, bool, error) {
		return []tooldeps.MarketQuote{{Label: "코스피", Currency: "KRW", Price: 2700, PrevClose: 2690}},
	...
	fail := func(context.Context) ([]tooldeps.MarketQuote, int64, bool, error) {
