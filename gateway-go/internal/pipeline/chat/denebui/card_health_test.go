...
func TestReportCardHealthEmitsAdoptionSignals(t *testing.T) {
	...
	ReportCardHealth("짧은 답변입니다.", "client:main", log3)
	if containsMsg(*neither, msgCardAuthored) || containsMsg(*neither, msgAdoptionMiss) {
