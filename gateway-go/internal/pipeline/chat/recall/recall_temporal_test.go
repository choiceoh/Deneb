...
func TestParseRecallTemporalRangeAt(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"어제", "어제 단가 얼마였지", true,
			[]int64{tsKST(2026, 6, 14)},
			[]int64{tsKST(2026, 6, 15), tsKST(2026, 6, 13)},
		},
		{
			"그저께", "그저께 뭐라고 했어", true,
			[]int64{tsKST(2026, 6, 13)},
			[]int64{tsKST(2026, 6, 14)},
		},
		{
			"지난달", "지난달 트라이브 단가", true,
			[]int64{tsKST(2026, 5, 10)},
			[]int64{tsKST(2026, 6, 1), tsKST(2026, 4, 30)},
		},
		{
			"이번달", "이번 달에 만난 사람", true,
			[]int64{tsKST(2026, 6, 5)},
			[]int64{tsKST(2026, 5, 31)},
		},
		{
			"작년", "작년 견적 어땠지", true,
			[]int64{tsKST(2025, 7, 1)},
			[]int64{tsKST(2026, 1, 1), tsKST(2024, 12, 31)},
		},
		{
			"재작년", "재작년에 한 일", true,
			[]int64{tsKST(2024, 3, 1)},
			[]int64{tsKST(2025, 1, 1)},
		},
		{
			"올해", "올해 목표 뭐였지", true,
			[]int64{tsKST(2026, 2, 1)},
			[]int64{tsKST(2025, 12, 31)},
		},
		{
			"N월-past", "6월 단가 얼마", true,
			[]int64{tsKST(2026, 6, 10)},
			[]int64{tsKST(2026, 7, 1), tsKST(2025, 6, 10)},
		},
		{
			"N월-future-is-lastyear", "11월에 뭐 했지", true,
			[]int64{tsKST(2025, 11, 10)},
			[]int64{tsKST(2026, 11, 10)},
		},
