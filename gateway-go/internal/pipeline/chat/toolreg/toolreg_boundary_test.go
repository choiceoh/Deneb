...
func allSchemaCases() []schemaCase {
	return []schemaCase{
		{name: "read", build: readToolSchema},
		{name: "research_panel", build: researchPanelToolSchema},
		{name: "read_spillover", build: readSpilloverToolSchema},
		{name: "write", build: writeToolSchema},
		{name: "edit", build: editToolSchema},
		{name: "grep", build: grepToolSchema},
		{name: "exec", build: execToolSchema},
		{name: "process", build: processToolSchema},
		{name: "web", build: webToolSchema},
		{name: "cron", build: cronToolSchema},
		{name: "morning_letter", build: morningLetterToolSchema},
		{name: "evening_letter", build: eveningLetterToolSchema},
		{name: "message", build: messageToolSchema},
		{name: "gateway", build: gatewayToolSchema},
		{name: "sessions", build: sessionsToolSchema},
		{name: "sessions_spawn", build: sessionsSpawnToolSchema},
		{name: "subagents", build: subagentsToolSchema},
		{name: "send_file", build: sendFileToolSchema},
		{name: "chart", build: chartToolSchema},
		{name: "diagram", build: diagramToolSchema},
		{name: "files", build: filesToolSchema},
		{name: "skills", build: skillsToolSchema},
		{name: "deal_ledger", build: dealLedgerToolSchema},
		{name: "wiki", build: wikiToolSchema},
		{name: "notebook", build: notebookToolSchema},
		{name: "contacts", build: contactsToolSchema},
		{name: "calendar", build: calendarToolSchema},
		{name: "polaris", build: polarisToolSchema},
		{name: "knowledge", build: knowledgeToolSchema},
		{name: "fetch_tools", build: fetchToolsToolSchema},
		{name: "graphify", build: graphifyToolSchema},
		{name: "heartbeat_update", build: heartbeatUpdateToolSchema},
		{name: "todo", build: todoToolSchema},
		{name: "watch", build: watchToolSchema},
		{name: "observe", build: observeToolSchema},
		{name: "fleet", build: fleetToolSchema},
		{name: "phone_read", build: phoneReadToolSchema},
		{name: "phone_write", build: phoneWriteToolSchema},
		{name: "workfeed", build: workfeedToolSchema},
		{name: "transcribe", build: transcribeToolSchema},
		{name: "ocr", build: ocrToolSchema},
		{name: "market", build: marketToolSchema},
...
func TestActionEnumsAreNonEmptyUniqueAndDocumented(t *testing.T) {
	actionSchemas := []string{
		...
		"observe", "fleet", "workfeed", "goal", "mail_archive",
	}
	byName := make(map[string]schemaCase)
	for _, tc := range allSchemaCases() {
		byName[tc.name] = tc
