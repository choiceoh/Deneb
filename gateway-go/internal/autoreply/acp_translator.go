...
func (t *ACPTranslator) TranslatePromptToChat(input ACPPromptInput) (*DispatchConfig, string) {
...
func BuildACPDelivery(sessionKey, agentID string, result *AgentTurnResult) ACPDelivery {
	return ACPDelivery{
