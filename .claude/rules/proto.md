...
Shared type definitions compiled to Go.
...
- `./scripts/proto-gen.sh`. See also `make proto`.
- Outputs: `gateway-go/pkg/protocol/gen/*.pb.go`.
...
| Command | Description |
|---|---|
| `make proto` | Generate protobuf code (Go) |
