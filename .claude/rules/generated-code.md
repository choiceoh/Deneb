...
- To change what a generator produces, modify the generator itself (`gateway-go/cmd/tool-schema-gen/gen.py`, `gateway-go/cmd/model-caps-gen/gen.py`, `scripts/gen-ffi-errors.sh`, etc.).
