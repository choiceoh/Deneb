...
vi.mock("deneb/plugin-sdk/infra-runtime", async (importOriginal) => {
...
vi.mock("deneb/plugin-sdk/runtime-env", async (importOriginal) => {
  const actual = await importOriginal<typeof import("deneb/plugin-sdk/runtime-env")>();
  return {
    ...actual,
