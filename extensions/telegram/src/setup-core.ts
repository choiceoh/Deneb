...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "deneb/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://deneb.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("deneb logs --follow")}\` (safest)`,
