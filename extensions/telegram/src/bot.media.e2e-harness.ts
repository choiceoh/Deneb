...
type FetchRemoteMediaFn = typeof import("deneb/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as DenebConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("deneb/plugin-sdk/media-runtime")>,
) {
...
vi.mock("deneb/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("deneb/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("deneb/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
