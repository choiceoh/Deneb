...
} from "deneb/plugin-sdk/media-runtime";

type DescribeImageWithModel =
  typeof import("deneb/plugin-sdk/media-runtime").describeImageWithModel;
type TranscribeFirstAudio = typeof import("deneb/plugin-sdk/media-runtime").transcribeFirstAudio;
