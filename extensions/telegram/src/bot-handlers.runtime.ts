...
import { resolveAgentDir, resolveDefaultAgentId } from "deneb/plugin-sdk/agent-runtime";
...
import { resolveChannelConfigWrites } from "deneb/plugin-sdk/channel-runtime";
import { writeConfigFile } from "deneb/plugin-sdk/config-runtime";
import {
  loadSessionStore,
...
import { applyModelOverrideToSessionEntry } from "deneb/plugin-sdk/config-runtime";
import {
...
import { buildCommandsMessagePaginated } from "deneb/plugin-sdk/reply-runtime";
          ...
          try {
            ...
            if (errStr.includes("no text in the message")) {
              try {
                ...
                // Delete may fail if the message was already removed; reply to chat as fallback.
              }
