...
import type { DenebPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "deneb.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): DenebPluginConfigSchema {
  return {
