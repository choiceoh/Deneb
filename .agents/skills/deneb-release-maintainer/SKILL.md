---
name: deneb-release-maintainer
description: Maintainer workflow for Deneb releases, prereleases, changelog release notes, and publish validation. Use when Codex needs to prepare or verify stable or beta release steps, align version naming, assemble release notes, check release auth requirements, or validate publish-time commands and artifacts.
---

# Deneb Release Maintainer
...
- When cutting a mac release with a beta GitHub prerelease:
  ...
  - create a prerelease titled `deneb YYYY.M.D-beta.N`
...
- Core `deneb` publish uses GitHub trusted publishing.
- Do not use `NPM_TOKEN` or the plugin OTP flow for core releases.
- `@deneb/*` plugin publishes use a separate maintainer-only flow.
- Only publish plugins that already exist on npm; bundled disk-tree-only plugins stay unpublished.

## GHSA advisory work

- Use `deneb-ghsa-maintainer` for GHSA advisory inspection, patch/publish flow, private-fork validation, and GHSA API-specific publish checks.
